...
namespace DoAnCoSo_Nhom2.Migrations
{
    ...
    public partial class Demo1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Homestays",
                columns: new[] { "Id", "Address", "City", "Description", "Images", "Name", "PricePerNight" },
                values: new object[] { 1, "123 Beach Road", "Da Nang", "A beautiful homestay by the sea.", "[\"https://example.com/images/seaside1.jpg\",\"https://example.com/images/seaside2.jpg\"]", "Seaside Homestay", 50.00m });

            migrationBuilder.InsertData(
                table: "HomestayAmenities",
                columns: new[] { "AmenityId", "HomestayId" },
                values: new object[,]
                {
                    { 1, 1 },
                    { 2, 1 }
